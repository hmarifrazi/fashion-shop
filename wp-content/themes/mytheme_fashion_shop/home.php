...
<!-- silder End -->
<!-- about Us -->
	<div id="about_us" class="about_section" style="background-image: url(<?=get_template_directory_uri(); ?>/assets/image/about_img.jpg);width: 100%;background-repeat: no-repeat; background-size: cover;">
			...
			<div class="row">
				...
				<div class="col-sm-6">
					<div class="about_images wow slideInRight">
						<!--<img src="<?=get_template_directory_uri()?>/assets/image/about_img.jpg" width="100%" alt="silder images" title="silder images">-->
					</div>
				</div>
			</div>
		</div>
	...
	<div class="container-fluid">
		...
		<div class="row">
			<div class="col-lg-2 col-md-3 col-sm-4 col-xs-12">
				<div class="rashi_sign_box wow fadeInDown animated ">
					<div class="sign_box_img">
						<img src="<?=get_template_directory_uri()?>/assets/image/rashi/icon1.png" alt="icon1">
					</div>
			...
			<div class="col-lg-2 col-md-3 col-sm-4 col-xs-12">
				<div class="rashi_sign_box wow fadeInDown animated">
					<div class="sign_box_img">
						<img src="<?=get_template_directory_uri()?>/assets/image/rashi/icon2.png" alt="icon2">
					</div>
					<div class="sign_box_cont">
						<h4>Taurus</h4>
						<p>30 march 2020</p>
			...
			<div class="col-lg-2 col-md-3 col-sm-4 col-xs-12">
				<div class="rashi_sign_box wow fadeInDown animated">
					<div class="sign_box_img">
						<img src="<?=get_template_directory_uri()?>/assets/image/rashi/icon3.png" alt="icon3">
					</div>
					<div class="sign_box_cont">
						<h4>Gemini</h2>
						<p>30 march 2020</p>
			...
			<div class="col-lg-2 col-md-3 col-sm-4 col-xs-12">
				<div class="rashi_sign_box wow fadeInDown animated">
					<div class="sign_box_img">
						<img src="<?=get_template_directory_uri()?>/assets/image/rashi/icon4.png" alt="icon4">
					</div>
					<div class="sign_box_cont">
						<h4>Cancer</h4>
						<p>30 march 2020</p>
			...
			<div class="col-lg-2 col-md-3 col-sm-4 col-xs-12">
				<div class="rashi_sign_box wow fadeInDown animated">
					<div class="sign_box_img">
						<img src="<?=get_template_directory_uri()?>/assets/image/rashi/icon5.png" alt="icon5">
					</div>
					<div class="sign_box_cont">
						<h4>leo</h4>
						<p>30 march 2020</p>
			...
			<div class="col-lg-2 col-md-3 col-sm-4 col-xs-12">
				<div class="rashi_sign_box wow fadeInDown animated">
					<div class="sign_box_img">
						<img src="<?=get_template_directory_uri()?>/assets/image/rashi/icon6.png" alt="icon6">
					</div>
					<div class="sign_box_cont">
						<h4>Virgo</h4>
						<p>30 march 2020</p>
			...
			<div class="col-lg-2 col-md-3 col-sm-4 col-xs-12">
				<div class="rashi_sign_box wow fadeInDown animated">
					<div class="sign_box_img">
						<img src="<?=get_template_directory_uri()?>/assets/image/rashi/icon7.png" alt="icon7">
					</div>
					<div class="sign_box_cont">
						<h4>Libra</h4>
						<p>30 march 2020</p>
			...
			<div class="col-lg-2 col-md-3 col-sm-4 col-xs-12">
				<div class="rashi_sign_box wow fadeInDown animated">
					<div class="sign_box_img">
						<img src="<?=get_template_directory_uri()?>/assets/image/rashi/icon8.png" alt="icon8">
					</div>
					<div class="sign_box_cont">
						<h4>Scorpio</h4>
						<p>30 march 2020</p>
			...
			<!--1 -->
					...
					<div class="col-sm-12">
						<div class="product-thumb">
							<div class="image wow fadeInDown animated">
									<a href="single-products.html"><img class="wow fadeInDown animated" src="<?= get_template_directory_uri();?>/assets/image/category/product-1.jpg" alt="Kundli Dosha" title="Kundli Dosha" width="100%"></a>
				...
				<div class="item">
					<div class="col-sm-12">
						<div class="product-thumb">
							<div class="image wow fadeInDown animated">
								<a href="single-products.html"><img class="wow fadeInDown animated" src="<?= get_template_directory_uri();?>/assets/image/category/product-2.jpg" alt="Kundli Dosha" title="Kundli Dosha" width="100%"></a>
				...
				<div class="item">
					<div class="col-sm-12">
						<div class="product-thumb">
							<div class="image wow fadeInDown animated">
								<a href="single-products.html"><img class="wow fadeInDown animated" src="<?= get_template_directory_uri();?>/assets/image/category/product-3.jpg" alt="Kundli Dosha" title="Kundli Dosha" width="100%"></a>
								<div class="button-group">
									<div class="inner">
										<button type="button" title="Quick View" class="button-quickview"><span>Quick View</span></button>
										<button type="button" title="Add to Wish List" class="button-wishlist"><span>Add to Wish List</span></button>
				...
				<div class="item">
					<div class="col-sm-12">
						<div class="product-thumb">
							<div class="image wow fadeInDown animated">
								<a href="single-products.html"><img class="wow fadeInDown animated" src="<?= get_template_directory_uri(); ?>/assets/image/category/product-4.jpg" alt="Kundli Dosha" title="Kundli Dosha" width="100%"></a>
								<div class="button-group">
									<div class="inner">
										<button type="button" title="Quick View" class="button-quickview"><span>Quick View</span></button>
										<button type="button" title="Add to Wish List" class="button-wishlist"><span>Add to Wish List</span></button>
				...
				<!--5 -->	
					<div class="item">
						<div class="col-sm-12">
							<div class="product-thumb">
								<div class="image wow fadeInDown animated">
									<a href="single-products.html"><img class="wow fadeInDown animated" src="<?= get_template_directory_uri(); ?>/assets/image/category/product-5.jpg" alt="Kundli Dosha" title="Kundli Dosha" width="100%"></a>
...
<div id="website_visitors" class="astrologers-work" style="background-image: url(<?=get_template_directory_uri(); ?>/assets/image/bg-banner.jpg);width: 100%;background-repeat: no-repeat; background-size: cover;">>
	<div class="container-fluid">
		<div class="row">
			...
			<!--1 -->
				...
				<div class="item">
					<div class="col-sm-12">
						<div class="product-thumb">
							<div class="image wow fadeInDown animated">
								<a href="single-products.html"><img class="wow fadeInDown animated" src="<?= get_template_directory_uri(); ?>/assets/image/category/product-6.jpg" alt="Kundli Dosha" title="Kundli Dosha" width="100%"></a>
				...
				<div class="item">
					<div class="col-sm-12">
						<div class="product-thumb">
							<div class="image wow fadeInDown animated">
								<a href="single-products.html"><img class="wow fadeInDown animated" src="<?= get_template_directory_uri(); ?>/assets/image/category/product-8.jpg" alt="Kundli Dosha" title="Kundli Dosha" width="100%"></a>
								<div class="button-group">
									<div class="inner">
										<button type="button" title="Quick View" class="button-quickview"><span>Quick View</span></button>
										<button type="button" title="Add to Wish List" class="button-wishlist"><span>Add to Wish List</span></button>
				...
				<div class="item">
					<div class="col-sm-12">
						<div class="product-thumb">
							<div class="image wow fadeInDown animated">
								<a href="single-products.html"><img class="wow fadeInDown animated" src="<?= get_template_directory_uri(); ?>/assets/image/category/product-11.jpg" alt="Kundli Dosha" title="Kundli Dosha" width="100%"></a>
								<div class="button-group">
									<div class="inner">
										<button type="button" title="Quick View" class="button-quickview"><span>Quick View</span></button>
										<button type="button" title="Add to Wish List" class="button-wishlist"><span>Add to Wish List</span></button>
				...
				<!--5 -->	
					<div class="item">
						<div class="col-sm-12">
							<div class="product-thumb">
								<div class="image wow fadeInDown animated">
									<a href="single-products.html"><img class="wow fadeInDown animated" src="<?= get_template_directory_uri(); ?>/assets/image/category/product-10.jpg" alt="Kundli Dosha" title="Kundli Dosha" width="100%"></a>
			...
			<div class="row">
				<div class="col-sm-4">
					<div class="services_matter">
						<img class="wow fadeInDown animated" src="<?=get_template_directory_uri()?>/assets/image/services/services3.jpg" alt="Kundli Dosha" title="Kundli Dosha" width="100%">
				...
				<div class="col-sm-4">
					<div class="services_matter">
						<img class="wow fadeInDown animated" src="<?=get_template_directory_uri()?>/assets/image/services/services2.jpg" alt="Kundli Dosha" title="Kundli Dosha" width="100%">
				...
				<div class="col-sm-4">
					<div class="services_matter">
						<img class="wow fadeInDown animated" src="<?=get_template_directory_uri()?>/assets/image/services/services1.jpg" alt="Kundli Dosha" title="Kundli Dosha" width="100%">
				...
				<div class="row">
					<div id="testimonial" class="owl-carousel owl-theme">
						<div class="item">
							<div class="col-sm-12">
								<div class="testimonial_inner_matter">
									<img src="<?= get_template_directory_uri(); ?>/assets/image/testimonial/1.jpg" class="wow fadeInDown animated">
						...
						<div class="item">
							<div class="col-sm-12">
								<div class="testimonial_inner_matter">
									<img src="<?= get_template_directory_uri(); ?>/assets/image/testimonial/2.jpg" class="wow fadeInDown animated">
									<p class="wow fadeInDown animated">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable.</p>
									<h5 class="wow fadeInDown animated">Shoko Mugikura</h5>
									<h6 class="wow fadeInDown animated">Design Manager</h6>
								</div>
						...
						<div class="item">
							<div class="col-sm-12">
								<div class="testimonial_inner_matter">
									<img src="<?= get_template_directory_uri(); ?>/assets/image/testimonial/3.jpg" class="wow fadeInDown animated">
									<p class="wow fadeInDown animated">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable.</p>
									<h5 class="wow fadeInDown animated">Shoko Mugikura</h5>
									<h6 class="wow fadeInDown animated">Design Manager</h6>
								</div>
						...
						<div class="item">
							<div class="col-sm-12">
								<div class="testimonial_inner_matter">
									<img src="<?= get_template_directory_uri(); ?>/assets/image/testimonial/4.jpg" class="wow fadeInDown animated">
									<p class="wow fadeInDown animated">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable.</p>
									<h5 class="wow fadeInDown animated">Shoko Mugikura</h5>
									<h6 class="wow fadeInDown animated">Design Manager</h6>
								</div>
					...
					<div id="blog" class="owl-carousel owl-theme">
						...
						<div class="item">
							<div class="col-sm-12">
								<div class="blog_inner_matter">
									<div class="image">
										<a href=""><img src="<?= get_template_directory_uri(); ?>/assets/image/blog/1.jpg" class="wow fadeInDown animated"></a>
						...
						<div class="item">
							<div class="col-sm-12">
								<div class="blog_inner_matter">
									<div class="image">
										<a href=""><img src="<?= get_template_directory_uri(); ?>/assets/image/blog/3.jpg" class="wow fadeInDown animated"></a>
										<div class="blog_date  wow fadeInDown animated">
											<span>01-04-2020<span>
										</div>
									</div>
						...
						<div class="item">
							<div class="col-sm-12">
								<div class="blog_inner_matter">
									<div class="image">
										<a href=""><img src="<?= get_template_directory_uri(); 
										?>/assets/image/blog/2.jpg" class="wow fadeInDown animated"></a>
										<div class="blog_date  wow fadeInDown animated">
											<span>01-04-2020<span>
										</div>
									</div>
						...
						<div class="item">
							<div class="col-sm-12">
								<div class="blog_inner_matter">
									<div class="image">
										<a href=""><img src="<?= get_template_directory_uri(); 
										?>/assets/image/blog/1.jpg" class="wow fadeInDown animated"></a>
										<div class="blog_date  wow fadeInDown animated">
											<span>01-04-2020<span>
										</div>
									</div>
    ...
    jQuery('#slideWiz').slideWiz({
        ...
        file: [
					...
					<?php while ( $the_query->have_posts() ){ $the_query->the_post(); ?>
						{
							src: {
								main: "<?= get_the_post_thumbnail_url()  ?>",
								cover: "<?= get_the_post_thumbnail_url()  ?>"
							},
							title: "<?php the_title(); ?>",
							desc: "<?php echo strip_tags( get_the_excerpt() ); ?>",
							descLength: 220,
							button: {
								text: 'Shop Now',
								url: '<?= get_permalink() ?>',
